...
public class AplikasiStarmix extends javax.swing.JFrame {
    ...
    private void btnCariBarangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCariBarangActionPerformed
        ...
        if(!txtCariBarang.getText().isEmpty() && !txtCariBarang.getText().isBlank() && FieldCari.getSelectedItem() != "-Pilih-"){
            try {
                ...
                if(i == 1){
                    JOptionPane.showMessageDialog(rootPane, "Mohon Maaf, Data tidak ditemukan!", "Gagal", JOptionPane.INFORMATION_MESSAGE);
                    showTabelBarang();
                }
            } catch (SQLException e) {
                System.out.println("Data barang gagal di tampilkan");
            ...
            JOptionPane.showMessageDialog(rootPane, "Inputan pencarian harus diisi dengan benar!", "Gagal", JOptionPane.ERROR_MESSAGE);
            showTabelBarang();
        }
                   ...
                   if(Integer.parseInt(harga) >= 0){
                       if(Integer.parseInt(stok) > 0){
                            ...
                            try {
                                ...
                                preStmt.execute();
                                JOptionPane.showMessageDialog(rootPane, "Barang berhasil ditambahkan!", "Berhasil", JOptionPane.INFORMATION_MESSAGE);
                                RefreshTampilanAdmin();
                           ...
                           JOptionPane.showMessageDialog(rootPane, "Minimum stok adalah 1", "Gagal", JOptionPane.ERROR_MESSAGE);
                       }
                   }else{
    ...
    private void btnSimpan_UbahBarangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpan_UbahBarangActionPerformed
        ...
        if(kodeUbahBarang == null){
            JOptionPane.showMessageDialog(rootPane, "Pilih data yang akan diubah pada tabel di atas!", "Gagal", JOptionPane.ERROR_MESSAGE);
        }else{
                        ...
                        if(Integer.parseInt(harga) >= 0){
                            if(Integer.parseInt(stok) > 0){
                                ...
                                try {
                                    ...
                                    PreparedStatement preStmt = conn.prepareStatement(insrt);
                                    preStmt.execute();
                                    JOptionPane.showMessageDialog(rootPane, "Barang berhasil diubah!", "Berhasil", JOptionPane.INFORMATION_MESSAGE);
                                    RefreshTampilanAdmin();
        ...
        try {
            if(!kode.isEmpty() && !kode.isBlank() && !jumlah.isEmpty() && !jumlah.isBlank()){
                if(jumlah.matches("\\d+")){
                    ...
                    if(resKode == null){
                        JOptionPane.showMessageDialog(rootPane, "Barang belum terdaftar!", "Gagal", JOptionPane.ERROR_MESSAGE);
                    }else{
                        if(resStok > 0){
                            if(Integer.parseInt(jumlah) > resStok){
                                JOptionPane.showMessageDialog(rootPane, "Jumlah melebihi stok barang!", "Gagal", JOptionPane.ERROR_MESSAGE);
                            }else{
                                ...
                                if(Integer.parseInt(jumlah) > 0){
                                    ...
                                    JOptionPane.showMessageDialog(rootPane, "Barang berhasil ditambahkan ke keranjang!", "Berhasil", JOptionPane.INFORMATION_MESSAGE);
                            ...
                            JOptionPane.showMessageDialog(rootPane, "Stok barang telah Habis!", "Gagal", JOptionPane.ERROR_MESSAGE);
                        }
                    }
                }else{
    ...
    private void btnHapus_SemuaKeranjangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapus_SemuaKeranjangActionPerformed
        ...
        try {
            ...
            JOptionPane.showMessageDialog(rootPane, "Permintaan ditolak!", "Gagal", JOptionPane.ERROR_MESSAGE);
            RefreshTampilanTransaksi();
            System.out.println(e);
        }
            ...
            if (uang.matches("\\d+")) {   
                try {
                    ...
                    if(banyakItemKeranjang == 0){
                        JOptionPane.showMessageDialog(rootPane, "Keranjang masih kosong!", "Gagal", JOptionPane.ERROR_MESSAGE);
                    }else{
            ...
            if(!kode.isEmpty() && !kode.isBlank()){
                if (jumlah.matches("\\d+")) {
                    if(Integer.parseInt(jumlah) > 0){
                        try {
                            ...
                            if(Integer.parseInt(jumlah) > Integer.parseInt(jumlahKeranjang)){
                                ...
                                if(Integer.parseInt(stokBarang) < selisih){
                                    JOptionPane.showMessageDialog(rootPane, "Stok barang tidak mencukupi jumlah yang ditambah ke keranjang!", "Gagal", JOptionPane.ERROR_MESSAGE);
                                }else{
                                    ...
                                    PreparedStatement preStmt = conn.prepareStatement(insrt);
                                    preStmt.execute();
                                    JOptionPane.showMessageDialog(rootPane, "Keranjang berhasil diubah!", "Berhasil", JOptionPane.INFORMATION_MESSAGE);
                                    RefreshTampilanTransaksi();
                                    RefreshTampilanAdmin();
                                }
                        ...
                        JOptionPane.showMessageDialog(rootPane, "Minimum jumlah adalah 1", "Gagal", JOptionPane.ERROR_MESSAGE);
                    }
                } else {
                    JOptionPane.showMessageDialog(rootPane, "Jumlah hanya boleh berupa Angka!", "Gagal", JOptionPane.ERROR_MESSAGE);
                }
    ...
    private void btnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrintActionPerformed
        ...
        if("0".equals(lblRingkasan_Uang.getText())){
           JOptionPane.showMessageDialog(rootPane, "Harap selesaikan pembayaran!", "Gagal", JOptionPane.ERROR_MESSAGE);
        } else{
